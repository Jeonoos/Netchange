    ...
    class Server
    {
        ...
        private void AcceptLoop(TcpListener handle)
        {
            while (true)
            {
                ...
                //    Program.PrefBuur[zijnPoort] = zijnPoort;
                //    if (!Program.Afstand.ContainsKey(zijnPoort))
                //        Program.Afstand[zijnPoort] = 1;

                //    Program.Buren[zijnPoort].Write.WriteLine(Program.MyDistance(Program.MijnPoort, 0));
                //}
            }
        }
    }
